...
export function ThemeSelector() {
  ...
  return (
    <div className="space-y-6">
            ...
            >
              <div className="flex flex-col items-center gap-2">
                <div className="flex gap-1.5">
                  <div
                    className="w-8 h-8 rounded-full border border-m3-outline"
      ...
      <div className="flex items-center justify-between p-4 border border-m3-outline rounded-lg bg-m3-tertiary-container">
              <div>
