...
export function AddMarkerButton() {
  ...
  return (
    <button
      ...
      className="absolute bottom-4 right-4 z-[1000] w-14 h-14 rounded-full bg-m3-primary text-m3-on-primary shadow-lg hover:bg-m3-primary-hover active:bg-m3-primary-pressed active:scale-95 transition-all duration-200 flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-m3-primary focus:ring-offset-2"
